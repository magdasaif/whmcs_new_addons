...
/*
$tblhtml .= '<td><strong>tenant</strong></td>
        <td><strong>package</strong></td>
        <td><strong>duration</strong></td>
        <td><strong>type</strong></td>';
*/

$tblhtml .= '<td><strong>description</strong></td>
...
foreach ($invoiceitems as $item) {
    $all_description = explode(",", $item['description']);
    $tblhtml .= '
    <tr bgcolor="#fff">';
    
        
   /* $tblhtml .= '<td align="left">' . nl2br(($all_description[0])??'-') . '<br /></td>
                <td align="left">' . nl2br(($all_description[1])??'-') . '<br /></td>
                <td align="left">' . nl2br(($all_description[2])??'-') . '<br /></td>
                <td align="left">' . nl2br(($all_description[3])??'-') . '<br /></td>';
     */   
