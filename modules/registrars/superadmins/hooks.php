<?php
/**
 * WHMCS SDK Sample SuperAdmin Module Hooks File
 *
...
add_hook('AdminHomeWidgets', 1, function() {
    return new SampleSuperAdminModuleWidget();
});

/**
 * Sample SuperAdmin Module Admin Dashboard Widget.
 *
 * @see https://developers.whmcs.com/addon-modules/admin-dashboard-widgets/
 */
class SampleSuperAdminModuleWidget extends \WHMCS\Module\AbstractWidget
{
    protected $title = 'Sample SuperAdmin Module';
