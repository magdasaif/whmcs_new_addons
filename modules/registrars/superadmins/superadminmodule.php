 ...
 * example this file, the filename is "superadminmodule.php" and therefore all
 * function begin "superadminmodule_".
 *
...
use WHMCS\Module\Registrar\superadminmodule\ApiClient;
...
{
    return array(
        'DisplayName' => 'Sample New Module for WHMCS',
        'APIVersion' => '1.1',
    );
}

/**
 * Define superadminmodule configuration options.
 *
 ...
 * @return array
 */
function superadminmodule_getConfigArray()
{
    return [
        // Friendly display name for the module
        'FriendlyName' => [
            'Type' => 'System',
            'Value' => 'Sample New Module for WHMCS',
        ],
 ...
 * @return array
 */
function superadminmodule_RegisterDomain($params)
{
 ...
 * @return array
 */
function superadminmodule_TransferDomain($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function superadminmodule_RenewDomain($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function superadminmodule_GetNameservers($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function superadminmodule_SaveNameservers($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function superadminmodule_GetContactDetails($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function superadminmodule_SaveContactDetails($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 */
function superadminmodule_CheckAvailability($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 */
function superadminmodule_DomainSuggestionOptions() {
    return array(
        'includeCCTlds' => array(
 ...
 * @return \WHMCS\Domains\DomainLookup\ResultsList An ArrayObject based collection of \WHMCS\Domains\DomainLookup\SearchResult results
 */
function superadminmodule_GetDomainSuggestions($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 */
function superadminmodule_GetRegistrarLock($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function superadminmodule_SaveRegistrarLock($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 */
function superadminmodule_GetDNS($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function superadminmodule_SaveDNS($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function superadminmodule_IDProtectToggle($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 *
 */
function superadminmodule_GetEPPCode($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function superadminmodule_ReleaseDomain($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function superadminmodule_RequestDelete($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function superadminmodule_RegisterNameserver($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function superadminmodule_ModifyNameserver($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function superadminmodule_DeleteNameserver($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function superadminmodule_Sync($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function superadminmodule_TransferSync($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * the `superadminmodule_push` function when invoked.
 *
 * @return array
 */
 ...
 * @return array
 */
function superadminmodule_ClientAreaAllowedFunctions()
{
    return array(
        'Push Domain' => 'push',
    );
 ...
 * @return array
 */
function superadminmodule_push($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 */
function superadminmodule_ClientArea($params)
{
    $output = '
