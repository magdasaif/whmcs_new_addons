 ...
 * example file, the filename is "superadminmodule" and therefore all
 * functions begin "superadminmodule_".
 *
 ...
 * @return array
 */
function superadminmodule_MetaData()
{
    return array(
        'DisplayName' => 'Demo Provisioning/Superadmin Module',
 ...
 * @return array
 */
function superadminmodule_ConfigOptions()
{
    return array(
 ...
 */
function superadminmodule_CreateAccount(array $params)
{
    try {
 ...
 * @return string "success" or an error message
 */
function superadminmodule_SuspendAccount(array $params)
{
    try {
 ...
 * @return string "success" or an error message
 */
function superadminmodule_UnsuspendAccount(array $params)
{
    try {
 ...
 * @return string "success" or an error message
 */
function superadminmodule_TerminateAccount(array $params)
{
    try {
 ...
 * @return string "success" or an error message
 */
function superadminmodule_ChangePassword(array $params)
{
    try {
 ...
 * @return string "success" or an error message
 */
function superadminmodule_ChangePackage(array $params)
{
    try {
        // Call the service's change password function, using the values
        // provided by WHMCS in `$params`.
 ...
 * @return string "success" or an error message
 */
function superadminmodule_Renew(array $params)
{
    try {
        // Call the service's provisioning function, using the values provided
        // by WHMCS in `$params`.
 ...
 * @return array
 */
function superadminmodule_TestConnection(array $params)
{
    try {
 ...
 *
 * @see superadminmodule_buttonOneFunction()
 *
 * @return array
 */
function superadminmodule_AdminCustomButtonArray()
{
    return array(
 ...
 * @return array
 */
function superadminmodule_ClientAreaCustomButtonArray()
{
    return array(
 ...
 *
 * @see https://developers.whmcs.com/provisioning-modules/module-parameters/
 * @see superadminmodule_AdminCustomButtonArray()
 *
 * @return string "success" or an error message
 */
function superadminmodule_buttonOneFunction(array $params)
{
    try {
 ...
 *
 * @see https://developers.whmcs.com/provisioning-modules/module-parameters/
 * @see superadminmodule_ClientAreaCustomButtonArray()
 *
 * @return string "success" or an error message
 */
function superadminmodule_actionOneFunction(array $params)
{
    try {
        // Call the service's function, using the values provided by WHMCS in
        // `$params`.
 ...
 *
 * @see https://developers.whmcs.com/provisioning-modules/module-parameters/
 * @see superadminmodule_AdminServicesTabFieldsSave()
 *
 * @return array
 */
function superadminmodule_AdminServicesTabFields(array $params)
{
    try {
        // Call the service's function, using the values provided by WHMCS in
        // `$params`.
        ...
        return array(
            ...
            'Something Editable' => '<input type="hidden" name="superadminmodule_original_uniquefieldname" '
                . 'value="' . htmlspecialchars($response['textvalue']) . '" />'
                . '<input type="text" name="superadminmodule_uniquefieldname"'
                . 'value="' . htmlspecialchars($response['textvalue']) . '" />',
        );
    } catch (Exception $e) {
        // Record the error in WHMCS's module log.
 ...
 *
 * @see https://developers.whmcs.com/provisioning-modules/module-parameters/
 * @see superadminmodule_AdminServicesTabFields()
 */
function superadminmodule_AdminServicesTabFieldsSave(array $params)
{
    // Fetch form submission variables.
    $originalFieldValue = isset($_REQUEST['superadminmodule_original_uniquefieldname'])
        ? $_REQUEST['superadminmodule_original_uniquefieldname']
        : '';

    $newFieldValue = isset($_REQUEST['superadminmodule_uniquefieldname'])
        ? $_REQUEST['superadminmodule_uniquefieldname']
        : '';
 ...
 * @return array
 */
function superadminmodule_ServiceSingleSignOn(array $params)
{
    try {
 ...
 * @return array
 */
function superadminmodule_AdminSingleSignOn(array $params)
{
    try {
 ...
 * @return array
 */
function superadminmodule_ClientArea(array $params)
{
    ...
    }elseif ($requestedAction == 'productextradetails') {
        $serviceAction = 'productextradetails';
        $templateFile = 'templates/productextradetails.tpl';
    } else {
    ...
    if($action=='productextradetails'|| $action=='productdetails'){//productdetails
    ...
    try {
        ...
        $project_details  = Capsule::table('project_extra_details')->where('project_id',$product_details->gid)->first();

        

        // href="http://{{$tenant->finalDomain()}}{{$tenant->project->dashboard_path}}"
        $dashboard_details=retrieveDashboardData($host_id,$product_details->gid,$host_details->packageid);
